    ...
    <div class='inner-wrap'>
        <div class='oc-row oc-cdn'>
            <div class='oc-column oc-left-column'>
                ...
                <p>
                    <?php _e('A content delivery network (CDN) is a network of servers in multiple locations that save copies of your website closer to users’ location. <span class="oc-hidden-content">This means that your website data has to travel a shorter distance, making your site load quicker.  A CDN is especially useful if you have a lot of visitors spread across the globe.</span>', OCVCaching::textDomain); ?>
                </p>
                    ...
                    <div class="oc-cdn-feature-box oc-block" style="display:<?php echo $cdn_enabled === 'true' ? 'block' : 'none' ?>;">
                        ...
                        <div class="oc-block">
                            ...
                            <div id="dev_mode_enable_settings" style="display:<?php echo $dev_mode_checked === 'checked' ? 'block' : 'none' ?>;">
                                    <label class="oc_vcache_ttl_label"><?php _e('Disable development mode (hours)', OCVCaching::textDomain) ?><span class="tooltip"><span class="dashicons dashicons-info"></span><span class="tip-content left"><?php echo __('CDN will not work for logged-in users until development mode is active.', OCVCaching::textDomain) ?> <i aria-hidden="true"></i></span></span></label>
                                    <div class="oc-input-wrap">
                                        <input type="number" id="dev_mode_duration" value="<?php echo $dev_mode_duration ?>">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div id="exclude_cdn_enable_settings" style="display:<?php echo $exclude_cdn_checked === 'checked' ? 'block' : 'none' ?>;">
                                    <label class="oc_vcache_ttl_label">
                                        <?php _e('Specify files and folders to be excluded (one per line)', OCVCaching::textDomain) ?></label>
                                        <span class="tooltip"><span class="dashicons dashicons-info"></span><span class="tip-content left"><?php echo __('Specify files and folders you wish to exclude from CDN. For example:', OCVCaching::textDomain) ?>
                                                <br />.css
                                                <br />uploads
