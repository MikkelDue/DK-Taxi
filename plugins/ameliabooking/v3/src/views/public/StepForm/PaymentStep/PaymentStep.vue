<template>
  <div :class="props.globalClass" :style="cssVars">
    <div v-show="ready && !loading" class="am-fs__payments">
      ...
      <div class="am-fs__payments-sentence" v-if="Object.keys(availablePayments).filter(item => availablePayments[item]).length === 1">
        <p>
          {{
...
import {inject, provide, markRaw, watch, computed, onMounted} from "vue";
