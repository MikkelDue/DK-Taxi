...
Amelia is a well-known WordPress booking system plugin for secure appointment and event booking with a modern design of the booking forms and admin area. Quickly schedule appointments, book events, send custom email and SMS notifications and many more. Amelia WordPress booking plugin is perfect for gyms, clinics, spa and wellness centres, yoga studios, and beauty salons.
...
Amelia Lite WordPress Booking Plugin is an excellent solution for small companies and individuals. Amelia's appointment and event scheduler guarantee a comfortable and user-friendly experience. In addition, all front-end and back-end elements were designed with the mobile-first concept in mind, and the admin and customer interfaces work perfectly across various devices.
...
## Amelia Lite WordPress Booking Plugin Main Features:
...
##What you can find in Amelia Appointment and Event  Booking System commercial version:

- Email and SMS scheduled notifications (such as reminders and follow-ups)
- Custom notifications - creating totally new templates, multiple reminders or follow-ups that will be sent on the different day and time, or creating different messages for each service
- Recurring appointments - booking of multiple appointments for the same service that will repeat in a specific time increment
- Custom Fields for the booking forms - creating different types of custom fields that will be shown during the booking so the customer can enter additional data, special requests, its address, or upload some file
- Integrations with Zoom, Google Meet, Google Calendar, Outlook Calendar, Lesson Space, Facebook Pixel and Google Analytics
- Online payments through PayPal, Stripe, WooCommerce, Mollie, and Razorpay
- Search booking shortcode for Appointments that gives you the option to show the available appointments based on the entered search criteria
- Event Calendar booking shortcode for Events that gives you the option to show the upcoming events in a monthly calendar view
- Manage multiple employees - creating the employees database, with specific working hours, service schedule, capacity and price for each, as well as configuring the days off and special days
- Manage multiple locations - good for the businesses that offer their services on multiple locations
- Multilingual support - options to translate the names of services, categories, events, extras, notification templates, etc. in multiple languages that are set on your website
- More customize options to fully customize your booking experience - choosing colours, order of the fields and which fields will be mandatory
- Custom service options such as group booking, buffer times before and after, extras, deposit, and types of the payments for each service
...
- Packages of services - creating the packages of one or multiple services with a discount that will be shown to the customers to attract more purchases
- Event tickets - creating and offering different types of tickets with different prices
- Web Hooks - connecting Amelia with any other application using several different hooks and choosing which data will be sent

##IMPORTANT NEWS!

## In one of our newest versions, we introduced a new, remodelled and improved appointment booking form.

With this booking form, UX and UI are pushed to the next level. New appointment scheduling form comes with the overall look and feel improvement, and provides your clients with a smoother and enjoyable booking experience.

## Follow the list of improvements below:
...
New booking form is faster to load, more insightful, more intuitive, easier to navigate, and comes with more setting and customization options. Setting up the new booking form is easier, and the usage is straightforward. And what's most important, the new and improved Amelia Booking System is inviting and conversion-optimized.
