                ...
                <div class="am-package-rule">
                  <div>
                    <span :style="{color: formColors.formTextColor}">
                      <i class="el-icon-date"></i> {{ $root.labels.package_book_service }} {{ package.quantity ? $root.labels.package_book_service_2 + ' ' + package.quantity + ' ' + (package.quantity === 1 ? $root.labels.appointment.toLowerCase() : $root.labels.appointments.toLowerCase()) + '.' : '' }}
                    </span>
                  </div>
