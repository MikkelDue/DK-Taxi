    ...
    $oc_whitelistip = isset($spoption_checks['oc_spwhitelistip']) ? $spoption_checks['oc_spwhitelistip'] : '';
    ...
    $whitelist_ips = isset($sp_options['whitelist_ips']) ? $sp_options['whitelist_ips'] : array();
    ...
    <form id="sp-advanced-settings" class="sp-blocked-lists" name="sp-advanced-settings" method="post">
        ...
        <p class="description">
            <span class="prt-desc"> <?php _e('Here you can add specific IP addresses that you want to whitelist.', OC_SP_TEXTDOMAIN) ?></span></p>
