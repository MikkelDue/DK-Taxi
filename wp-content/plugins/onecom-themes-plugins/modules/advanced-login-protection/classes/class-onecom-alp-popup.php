...
class Onecom_ALP_Popup
{
    ...
    {
        // version added to resolve browser cache issue
        wp_enqueue_style('oc_alp_style', ONECOM_WP_URL . 'modules/advanced-login-protection/assets/css/alp.css',array(),ONECOM_WP_VERSION );
        wp_enqueue_script('oc_alp_script', ONECOM_WP_URL . 'modules/advanced-login-protection/assets/js/alp.js', ['jquery'], ONECOM_WP_VERSION, true);
    }
