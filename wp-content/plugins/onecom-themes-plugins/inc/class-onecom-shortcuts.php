    ...
    class Onecom_Shortcuts
    {
        ...
        public function render_html($scan=false){
            ...
            <div class="activity-block oc-reset-wlk-tour">
                <a class="btn button_4" href="#"><?php _e('Restart tour', OC_PLUGIN_DOMAIN) ?></a><span id="oc_hmwidget_spinner" class="oc_cb_spinner spinner"></span>

                <img class="onecom-logo" alt="onecom-logo" src="<?php echo ONECOM_WP_URL ?>/assets/images/one.com-logo@2x.svg"/>
            </div>
        ...
        public function oc_button_css(){
            ...
            echo "<style>
                ...
                #ocsh_dashboard_widget .btn.button_4 {
                    ...
                    #ocsh_dashboard_widget span.ocsh_widget_todo::before {
                        content: '';
                        border-right: 1px solid #BBBBBB;
                        margin: 0 41px;
                    }
                    #ocsh_dashboard_widget span.ocsh_widget_todo{
                        color: #BBBBBB;
                        font-weight: 600;
                    }
                    ...
                    @media (max-width: 576px) {
                        ...
                        #ocsh_dashboard_widget .activity-block:nth-child(2) h3 {
                            margin-bottom: 21px;
                        }
                        .oc_button{
                            margin-left:0px;
